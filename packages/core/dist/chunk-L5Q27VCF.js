...
`;
      ...
      if (run_checks) {
        ...
        successMessage += " \u{1F3AF} Outil cr\xE9\xE9 dans dist/tools/generated/ (outils g\xE9n\xE9r\xE9s vs natifs dans src/).";
      }
      try {
        ...
        if (tool) {
          ...
          if (!existingTool) {
            ...
            successMessage += ` Outil '${tool_name}' automatiquement enregistr\xE9 et pr\xEAt \xE0 l'emploi.`;
          } else {
            successMessage += ` Outil '${tool_name}' d\xE9j\xE0 enregistr\xE9 dans le syst\xE8me.`;
          }
        } else {
          successMessage += ` \u26A0\uFE0F  Impossible de charger automatiquement l'outil '${tool_name}'. Red\xE9marrage requis.`;
        }
      } catch (error) {
        const err = error;
        ctx.log.error(
        ...
        successMessage += ` \u26A0\uFE0F  Erreur lors de l'enregistrement automatique. Red\xE9marrage requis.`;
      }
