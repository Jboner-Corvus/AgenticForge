...
var QwenProvider = class {
  getErrorType(statusCode, _errorBody) {
    if (statusCode === 401 || statusCode === 403) {
      ...
      return LlmKeyErrorType.TEMPORARY;
    } else if (_errorBody.includes("invalid_api_key") || _errorBody.includes("Incorrect API key") || _errorBody.includes("invalid access token") || _errorBody.includes("token expired")) {
      return LlmKeyErrorType.PERMANENT;
    }
    return LlmKeyErrorType.TEMPORARY;
  }
