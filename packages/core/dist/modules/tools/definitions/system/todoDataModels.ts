...
// Enhanced todo item schema with all advanced features
export const enhancedTodoItemSchema = z.object({
  ...
  attachments: z
    ...
    .default([])
    .describe('Attachments for this task'),
  ...
  automationRules: z
    ...
    .default([])
    .describe('Automation rules for this task'),
  ...
  customFields: z
    ...
    .default({})
    .describe('Custom fields for additional task information'),
  ...
  labels: z
    .array(z.string())
    .default([])
    .describe('Custom labels for additional categorization'),
  parentId: z
    .string()
    .optional()
  ...
  subtasks: z
    .array(z.string())
    .default([])
    .describe('IDs of subtasks belonging to this task'),
  ...
  timeSpent: z
    .number()
    .default(0)
    .describe('Total time spent on this task in minutes'),
  ...
  watchers: z
    .array(z.string())
    .default([])
    .describe('Users watching this task for updates'),
});

// Enhanced project schema with comprehensive project management features
export const enhancedProjectSchema = z.object({
  actualEndDate: z.number().optional().describe('Actual end date timestamp'),
  actualStartDate: z
    .number()
    .optional()
    .describe('Actual start date timestamp'),
  // Resource management
  ...
  customFields: z
    .record(z.string(), z.any())
    .default({})
    .describe('Custom fields for additional project information'),
  // Dependencies
  dependencies: z
    .array(z.string())
    .default([])
    .describe('IDs of projects this project depends on'),
    ...
    .array(
      z.object({
        completed: z
          .boolean()
          .default(false)
          .describe('Whether milestone is completed'),
        completedAt: z
          .number()
          .optional()
          .describe('When milestone was completed'),
    ...
    .array(
      z.object({
        ...
        progress: z
          ...
          .max(100)
          .default(0)
          .describe('Phase progress percentage'),
  ...
  resources: z
    ...
    .default([])
    .describe('Resources allocated to this project'),
  ...
  team: z
    .array(
      z.object({
        assignedTasks: z
          .array(z.string())
          .describe('Tasks assigned to this member'),
    ...
    .default([])
    .describe('Team members assigned to this project'),
...
// Comment schema for detailed task discussions
export const commentSchema = z.object({
  ...
  reactions: z
    ...
    .default([])
    .describe('Reactions to this comment'),
  timestamp: z.number().describe('Timestamp when comment was created'),
});

// Attachment schema for file management
...
export const timeTrackingSchema = z.object({
  billable: z
    .boolean()
    .default(false)
    .describe('Whether this time is billable'),
...
export const automationRuleSchema = z.object({
  ...
  description: z
    .string()
    .optional()
    .describe('Description of what the rule does'),
...
// Export all schemas
export type EnhancedTodoItem = z.infer<typeof enhancedTodoItemSchema>;
export type PriorityLevel = z.infer<typeof enhancedTodoItemSchema>['priority'];

export type ProjectStatus = z.infer<typeof enhancedProjectSchema>['status'];
export type TimeTrackingEntry = z.infer<typeof timeTrackingSchema>;
// Utility types for common operations
export type TodoStatus = z.infer<typeof enhancedTodoItemSchema>['status'];
...
export const todoFiltersSchema = z.object({
  ...
  dueDateAfter: z
    .number()
    .optional()
    .describe('Filter by due date after this timestamp'),
  dueDateBefore: z
    .number()
    .optional()
    .describe('Filter by due date before this timestamp'),
  priority: z.array(z.string()).optional().describe('Filter by priority'),
  projectId: z.string().optional().describe('Filter by project'),
  search: z
    .string()
    .optional()
    .describe('Search in content, tags, and comments'),
