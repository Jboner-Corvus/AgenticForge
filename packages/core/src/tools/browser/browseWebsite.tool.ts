...
export const browseWebsiteTool: Tool<typeof browseWebsiteParams, typeof browseWebsiteOutput> = {
  name: 'browseWebsite',
  description: 'Navigates to a URL and extracts its textual content. Use this to get information from a specific webpage.',
  ...
  execute: async (args, ctx: Ctx) => {
    ...
    try {
      ...
      ctx.log.info(`Successfully fetched content from ${args.url}. Length: ${cleanedContent.length}`);
