...
const SymbolSearchParams = AlphaVantageBaseParams.extend({
  keywords: z
    ...
    .min(1)
    .describe(
      'Keywords to search for company symbols (e.g., "microsoft", "tech", "energy")',
    ),
});

export const symbolSearchTool: Tool<typeof SymbolSearchParams> = {
  description:
    'Search for symbols by keywords. Returns best matching symbols and company information based on the keywords',
