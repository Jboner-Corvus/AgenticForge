...
export const inflationTool: Tool<typeof InflationParams> = {
  description: 'Returns inflation rates data for the United States. This data represents the annual percentage change in consumer prices, which is a key economic indicator for monetary policy and investment decisions',
  ...
  execute: async (params, context) => {
    ...
    try {
      ...
      log.error({ err: error, params: parsedParams }, 'Error fetching inflation rates data');
      throw new Error(
