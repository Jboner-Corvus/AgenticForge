...
const FXDailyParams = AlphaVantageBaseParams.merge(OutputSizeParam)
  .merge(DataTypeParam)
  .extend({
    from_symbol: z
      .string()
...
export const fxDailyTool: Tool<typeof FXDailyParams> = {
  description:
    'Returns daily foreign exchange (FX) rates for the specified currency pair, including open, high, low, and close prices',
