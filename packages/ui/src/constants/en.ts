export const en = {
  ...
  oauthSecurityWarning:
    'Granting access to your accounts gives the agent full permissions. Please review and understand the implications before connecting.',
  ...
  oauthExplanation:
    'OAuth connections allow the agent to access external services on your behalf. When connected, the agent can perform actions like accessing repositories, creating issues, retrieving information from integrated services, posting to social media, or accessing cloud storage.',
  browserStatus: 'Browser Status',
  allowToolCreation: 'Allow the agent to create new tools based on its needs.',
  allowCodeExecution:
    'Allow the agent to execute code directly in the environment.',
  ...
  welcomeTitle: 'Welcome to Agent MCP!',
  welcomeMessage:
    'To get started, please set up your authentication and LLM API keys.',
