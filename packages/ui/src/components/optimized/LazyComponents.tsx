...
export const LeaderboardPage = lazy(() =>
  import('../LeaderboardPage').then((module) => ({
...
export const LlmApiKeyManagementPage = lazy(() =>
  import('../LlmApiKeyManagementPage').then((module) => ({
    default: module.LlmApiKeyManagementPage,
  })),
);

export const OAuthManagementPage = lazy(() =>
  import('../OAuthManagementPage').then((module) => ({
    default: module.OAuthManagementPage,
  })),
);
...
export const AgentOutputCanvas = lazy(() => import('../AgentOutputCanvas'));

export const EpicLayoutManager = lazy(() =>
  import('../EpicLayoutManager').then((module) => ({
    default: module.EpicLayoutManager,
  })),
);

export const DebugLogContainer = lazy(() =>
  import('../DebugLogContainer').then((module) => ({
    default: module.DebugLogContainer,
  })),
);
...
const SubAgentCLIViewImport = lazy(() => import('../SubAgentCLIView'));
export const SubAgentCLIView: React.FC<SubAgentCLIViewProps> = (props) => (
  <SubAgentCLIViewImport {...props} />
);
