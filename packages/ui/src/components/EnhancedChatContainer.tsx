...
export const EnhancedChatContainer: React.FC<EnhancedChatContainerProps> = ({
  ...
  return (
    <TooltipProvider>
      ...
      >
        {/* Header supprimé - utilisation du header principal uniquement */}

        <>
          {/* Zone de messages avec scroll personnalisé */}
          <div
            ref={messagesContainerRef}
            className={`flex-grow overflow-y-auto min-h-0 p-4 pb-24 relative ${containerStyles} backdrop-blur-sm`}
            style={{
              scrollbarWidth: 'thin',
              scrollbarColor:
                variant === 'pinned'
        ...
        {/* Version minimisée supprimée - pas nécessaire sans header */}
      </div>
    </TooltipProvider>
  );
};
