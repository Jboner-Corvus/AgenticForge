...
const SMART_SUGGESTIONS = [
  {
    ...
    prompt:
      "J'ai besoin d'aide pour écrire du code. Voici ce que je veux faire : ",
    color: 'text-blue-400',
  },
  {
    icon: FileText,
...
export const EnhancedChatInput: React.FC<EnhancedChatInputProps> = ({
  ...
  const handleSendMessage = () => {
    ...
    if (inputValue.trim() && !isProcessing) {
      ...
      try {
        console.log('🔄 [EnhancedChatInput] Calling startAgent...');
        startAgent(inputValue);
        console.log('✅ [EnhancedChatInput] startAgent called successfully');
        setInputValue('');
  ...
  return (
    <TooltipProvider>
      <div data-testid="user-input" className="relative w-full">
        ...
        <div
          className={`relative rounded-3xl border shadow-lg transition-all duration-300 ${
            variant === 'pinned'
        ...
        >
          ...
          <Textarea
            ...
            placeholder={
              ...
              "Écrivez votre message... (Ctrl+↑/↓ pour l'historique)"
            }
          ...
          <div className="absolute right-2 top-1/2 -translate-y-1/2 flex items-center gap-2">
            ...
            {/* Send/Stop Button */}
            <Button
              onClick={isProcessing ? handleStopAgent : handleSendMessage}
              size="icon"
              disabled={!isProcessing && (!inputValue.trim() || isProcessing)}
              className={
