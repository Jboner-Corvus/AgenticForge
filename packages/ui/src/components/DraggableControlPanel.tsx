...
import { Key, Server, Hammer, ListChecks, Play, History, Save, Edit, XCircle, AlertTriangle, Move } from 'lucide-react';
...
export const DraggableControlPanel = memo(() => {
  ...
  // Draggable hook
  const { position, handleDragStart, elementRef } = useDraggable({ x: 20, y: 20 });
  ...
  return (
    ...
    >
      ...
      <aside
        className="p-4 bg-gradient-to-b from-background to-secondary/30 border border-border relative pt-8 shadow-lg"
      >
