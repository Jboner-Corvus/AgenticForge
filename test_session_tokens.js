...
async function testTokenEstimation() {
  ...
  console.log(
    'After user message:',
    useSessionStore.getState().sessionTokensUsed,
  );
  ...
  store.addMessage({
    ...
    role: 'assistant',
    content:
      'Of course! I can help you with complex tasks. What would you like me to do?',
    timestamp: Date.now(),
  });
  ...
  store.addMessage({
    ...
    role: 'user',
    content:
      'I need you to navigate to a website, fill out a form with multiple fields, take screenshots at each step, and then analyze the results. This should test all your browser automation capabilities including form filling, element interaction, screenshot capture, and content analysis.',
    timestamp: Date.now(),
  });
