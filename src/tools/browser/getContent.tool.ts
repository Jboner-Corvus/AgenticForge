...
export async function getContentWorkerLogic(args: z.infer<typeof getContentParams>, _ctx: Ctx) {
...
export const getContentTool: Tool<typeof getContentParams> = {
  ...
  description: 'Extracts the visible text content from a web page. This is an async task.',
