...
import { addMessage, showTypingIndicator, hideTypingIndicator, updateTokenStatus, updateUserMessage } from './ui.js';
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    addMessage("Veuillez entrer votre Auth Token, puis décrivez votre objectif.", 'assistant');
    ...
    elements.toolCreationToggle.addEventListener('change', (e) => handleToggle(e, "La capacité de création d'outils"));
    elements.codeExecutionToggle.addEventListener('change', (e) => handleToggle(e, "La capacité d'exécution de code"));
...
function handleToggle(event, capabilityName) {
    ...
    console.log(`${capabilityName} est maintenant ${isEnabled ? 'activée' : 'désactivée'}.`);
    addMessage(`${capabilityName} a été ${isEnabled ? 'activée' : 'désactivée'}.`, 'client');
}
