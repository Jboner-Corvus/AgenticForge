...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const savedToken = localStorage.getItem('prometheusAuthToken');
    if (savedToken) {
...
function saveToken() {
    ...
    if (tokenValue) {
        ...
        localStorage.setItem('prometheusAuthToken', tokenValue);
        console.log('Token saved.');
    } else {
        state.authToken = null;
        localStorage.removeItem('prometheusAuthToken');
